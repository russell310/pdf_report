...
def WriteToExcel(weather_data, town=None):
    ...
    if town:
        ...
        town_text = "all recorded towns"
    title_text = "Weather History for {}".format(town_text)
    # merge cells
    ...
    worksheet_s.write(4, 2, "Date"), header
    worksheet_s.write(4, 3, "Description"), header
    worksheet_s.write(4, 4, "Max T."), header
    worksheet_s.write(4, 5, "Min T."), header
    worksheet_s.write(4, 6, "Wind (km/h)"), header
    worksheet_s.write(4, 7, "Precip. (mm)"), header
    worksheet_s.write(4, 8, "Precip. (%)"), header
    worksheet_s.write(4, 9, "Observations"), header
    ...
    for idx, t in enumerate(towns):
        ...
        line_chart.add_series({
            ...
            'marker': {'type': 'circle'},
            'name': "{0} {1}".format("Min T.", t.name)
        })
    # adding other options
    line_chart.set_title({'name': "Maximum and Minimum Temperatures"})
    ...
    # adding other options
    bar_chart.set_title({'name': "Maximum and minimum wind speeds"})
